...
async function main() {
  ...
  writeStructuredLog("info", "database-seed.courses.started");
  await fetchCourses();

  writeStructuredLog("info", "database-seed.templates.started");
  ...
  await createTemplate(
    {
      ...
      items: [
        ...
        },
        {
          type: "instruction",
          description:
            "The following List 1 and List 2 describe the Undergraduate Communication Requirement.",
          orderIndex: 12,
        },
        {
          type: "instruction",
  ...
  await createTemplate(
    {
      ...
      description:
        "2024 academic requirements for Computational Mathematics major",
      items: [
        {
          type: "instruction",
          description: "Complete all of the following",
        ...
        },
        {
          type: "requirement",
          description:
            "Complete 3 non-math courses, at least one of which is at the 200-, 300-, or 400-level, all from the same subject code, from the following choices: AE, BIOL, BME, CHE, CHEM, CIVE, EARTH, ECE, ECON, ENVE, GEOE, ME, MNS, MSE, MTE, NE, PHYS, SYDE",
          orderIndex: 5,
          courseType: "free",
          courses: [],
          courseCount: 3,
        ...
        },
        {
          type: "instruction",
          description:
            "List 2: Complete 2 courses total from the following groups:",
          orderIndex: 13,
        },
        {
          type: "requirement",
        ...
        },
        {
          type: "instruction",
          description:
            "Complete 4 additional courses from List 2 or List 3; choices must be in at least two different subject codes (AMATH, CO, CS, PMATH, STAT), and 2 courses must be at the 400-level",
          orderIndex: 18,
        },
        {
          type: "requirement",
  ...
  writeStructuredLog("info", "database-seed.completed");
}

main()
  .then(() => process.exit(0))
  .catch((err) => {
    writeApplicationError("database-seed.failed", err);
    process.exit(1);
  });
