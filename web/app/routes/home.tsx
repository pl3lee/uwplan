      ...
      <div className="flex w-full flex-col items-center justify-center space-y-4 px-4 py-24 text-center">
        ...
        <div className="space-x-4">
          ...
          <Button variant="outline" size="lg" asChild>
            <a href="#features" aria-label="Learn More about UWPlan features">
              Learn More
            </a>
          </Button>
        </div>
            ...
            <section className="mb-16">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  ...
                  aria-label="UWPlan on GitHub"
                  className="inline-flex items-center space-x-2 text-primary hover:underline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className="sr-only">UWPlan on GitHub</span>
                  <svg
                    aria-hidden="true"
                    className="h-5 w-5"
                    fill="currentColor"
      ...
      <div className="w-full bg-background py-16 text-center">
        <div className="mx-auto max-w-2xl space-y-4">
          ...
          <Button size="lg" asChild className="mt-4">
            <Link to="/signin">Start Planning Today →</Link>
          </Button>
        </div>
      </div>
