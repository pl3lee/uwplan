SELECT jsonb_build_object(
  ...
  'legacy_reversed_range', (SELECT jsonb_build_array(start_term,start_year,end_term,end_year) FROM user_term_range WHERE user_id='legacy-reversed-range'),
  'legacy_free_reference', (SELECT course_id::text FROM course_item WHERE id='66666666-6666-4666-8666-666666666666'),
